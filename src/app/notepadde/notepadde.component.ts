...
import { Message } from '../notepad/Message';

@Component({
  selector: 'app-notepadde',
  templateUrl: './notepadde.component.html',
  styleUrls: ['../notepad/notepad.component.css']
})
export class NotepaddeComponent implements OnInit {
  NoteMessage: string;
